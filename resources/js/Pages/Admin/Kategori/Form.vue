                        ...
                        <fieldset class="text-xs grid grid-cols-3 gap-6 p-6 rounded-md shadow-sm bg-gray-50">
                            <div class="grid grid-cols-6 gap-4 col-span-full lg:col-span-3">
                                <div class="col-span-full md:col-span-3">
                                    <InputLabel for="nama" value="Nama Penilaian" />
                                    <TextInput id="nama" type="text" placeholder="Nama Penilaian" v-model="Form.nama"
                                        class="w-full text-gray-900" />
                                    <InputError :message="Form.errors.nama" />
                                </div>
                                <div class="col-span-full md:col-span-3">
                                    <InputLabel for="tanggal" value="Tanggal Penilaian" />

                                    <TextInput id="tanggal" type="date" placeholder="Tanggal Penilaian"
                                ...
                                <div class="col-span-full md:col-span-3  relative">
                                    <InputLabel for="Keterangan" value="Keterangan Penilaian" />
                        ...
                        <div class="flex flex-col md:flex-row gap-3 ">
                            <div class="relative overflow-x-auto mt-3">
                                <table class="w-full text-xs text-left rtl:text-right text-gray-500">
                                    <caption class="py-1 text-sm bg-primary text-white border-b border-white">Pilih Karyawan</caption>
                                    ...
                                    <tbody>
                                        <tr class="bg-white border-b" v-for="(item, index) in DataKaryawan" :key="index">
                                            ...
                                            <td class="px-6 py-4">
                                                <input id="default-checkbox" type="checkbox" @change="addSliceArray(index,item)"
                            ...
                            <div class="relative overflow-x-auto mt-3">
                                <table class="w-full text-xs text-left rtl:text-right text-gray-500">
                                    <caption class="py-1 text-sm bg-primary text-white border-b border-white">Karyawan Terpilih</caption>
                                    <thead class="text-xs text-white uppercase bg-primary ">
                                        <tr>
                                            <th scope="col" class="px-6 py-3">
                                                Nama Karyawan
                                    ...
                                    <tbody>
                                        <tr class="bg-white border-b" v-for="(item, index) in CheckBoxKaryawan" :key="index">
                                            <th scope="row" class="px-6 py-4 font-medium text-sm capitalize text-gray-900 whitespace-nowrap">
                                                {{ item.nama }}
                                            </th>
                                            <td class="px-6 py-4">
